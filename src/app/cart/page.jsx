...
export default function CartPage() {
  ...
  if (cart.length === 0) {
    return (
      <section className="container mx-auto flex flex-col items-center justify-center gap-4 px-4 py-28 text-center">
  ...
  return (
    <section className="container mx-auto px-4 py-10 md:py-14 max-w-4xl">
            ...
            <div className="card-body p-0 pl-4 md:pl-5 flex flex-row justify-between">
              <div className="flex flex-col justify-between py-1">
                ...
                <div className="join border border-[#E7E1D4] rounded-full w-fit mt-3 md:mt-0">
                  ...
                  <span className="join-item flex items-center justify-center w-8 text-sm font-medium text-[#1C1917]">
                    {item.quantity}
                  </span>
                  <button
                    type="button"
      ...
      <div className="flex flex-col gap-6 bg-[#FBF9F4] border border-[#E7E1D4] rounded-2xl p-5 md:p-6">
