...
const features = [
  { icon: Truck, title: "Fast Delivery", desc: "Nationwide shipping, right to your doorstep in days." },
  { icon: RotateCcw, title: "Easy Returns", desc: "Not satisfied? Return within 7 days, hassle-free." },
  { icon: ShieldCheck, title: "Secure Checkout", desc: "Your payments and data are always protected." },
  { icon: BadgeCheck, title: "Authentic Quality", desc: "Every piece is crafted with premium materials." },
];
    ...
    <section className="bg-[#FBF9F5] border-y border-[#EDE7DE]">
      <div className="container mx-auto px-4 py-10 md:py-16">
        <div className="mb-8 md:mb-10 text-center">
          <p className="text-xs uppercase tracking-[0.14em] text-[#8C8478]">Why Us</p>
          <h2
        ...
        >
          {features.map(({ icon: Icon, title, desc }) => (
            ...
            >
              ...
              <h3 className="text-sm md:text-base font-semibold text-[#1C1917] mb-1">{title}</h3>
              <p className="text-xs md:text-sm text-[#8C8478] leading-relaxed">{desc}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
